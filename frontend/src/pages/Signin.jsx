...
export default function Signin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative bg-base">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-purple-900/20 via-base to-base z-0" />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-surface/80 backdrop-blur-xl p-8 rounded-2xl border border-subtle shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-txt-sec text-sm mt-1">Sign in to your account</p>
          </div>
